...
public class DocumentFormat implements java.io.Serializable {
    ...
    public static final java.lang.String _CORPUS = "CORPUS";
    public static final DocumentFormat TXT = new DocumentFormat(_TXT);
    public static final DocumentFormat XML = new DocumentFormat(_XML);
    public static final DocumentFormat CORPUS = new DocumentFormat(_CORPUS);
    public java.lang.String getValue() { return _value_;}
    public static DocumentFormat fromValue(java.lang.String value)
          throws java.lang.IllegalArgumentException {
        DocumentFormat enumeration = (DocumentFormat)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DocumentFormat.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://plwordnet.pwr.wroc.pl/clarin/ws/takipi/", "DocumentFormat"));
    }
    /**
